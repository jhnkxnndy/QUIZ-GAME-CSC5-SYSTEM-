...
Public Class MCQuestion8
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        QuestionScores.Q8Panel.FillColor = Color.LightGreen ' Change the panel color for the correct answer
        flickerTimer.Start()
        correctSound.Play()
    ...
    Private Sub FlickerEffect(sender As Object, e As EventArgs)
        ...
        Else
            flickerTimer.Stop()
            Guna2Button2.FillColor = Color.LightGreen
            QuestionScores.Q8Panel.FillColor = Color.LightGreen ' Set the panel color as well
            currentPhase = 1
        End If
    End Sub
        ...
        Select Case currentPhase
            Case 1
                ...
                If questionScores Is Nothing Then
                    ...
                    questionScores.Q8Panel.FillColor = Color.Gray ' Reflect the correct color
                    questionScores.Show()
                Else
                    questionScores.Q8Panel.FillColor = Color.Gray ' Update the color for an existing form
                End If
            ...
            Case 2
                ...
                ' Show MCQuestion9 in Guna2Panel1
                Dim mcInterface As MCInterface = Application.OpenForms.OfType(Of MCInterface)().FirstOrDefault()
                If mcInterface IsNot Nothing Then
                    mcInterface.Guna2Panel1.Controls.Clear()
                    Dim mcQuestion9 As New MCQuestion9() ' Replace with the actual next question form
    ...
    Private Sub MCQuestion8_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        MCInterface.QuestionLbl.Text = "8" ' Update question label to show it's Question 8
    End Sub
