...
Public Class MCQuestion9
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "Q9Panel"
                    QuestionScores.Q9Panel.FillColor = newColor
            End Select
        End If
    End Sub
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        ...
        UpdatePanelColor("Q9Panel", Color.LightGreen)
        QuestionScores.Q9Panel.FillColor = Color.LightGreen ' Change the panel color for the correct answer
        flickerTimer.Start()
        correctSound.Play()
    ...
    Private Sub HandleWrongAnswer(button As Guna.UI2.WinForms.Guna2Button)
        ...
        UpdatePanelColor("Q9Panel", Color.FromArgb(255, 51, 52))
        QuestionScores.Q9Panel.FillColor = Color.FromArgb(255, 51, 52)
        flickerTimer.Start()
        wrongSound.Play()
        ShowWrongForm()
    End Sub
    ...
    Private Sub FlickerEffect(sender As Object, e As EventArgs)
        ...
        Else
            flickerTimer.Stop()
            Guna2Button1.FillColor = Color.LightGreen
            QuestionScores.Q9Panel.FillColor = Color.LightGreen ' Set the panel color as well
            currentPhase = 1
        End If
    End Sub
        ...
        Select Case currentPhase
            Case 1
                ...
                If questionScores Is Nothing Then
                    ...
                    questionScores.Q9Panel.FillColor = Color.Gray ' Reflect the correct color
                    questionScores.Show()
                Else
                    questionScores.Q9Panel.FillColor = Color.Gray ' Update the color for an existing form
                End If
            ...
            Case 2
                ...
                ' Show MCQuestion10 in Guna2Panel1
                Dim mcInterface As MCInterface = Application.OpenForms.OfType(Of MCInterface)().FirstOrDefault()
                If mcInterface IsNot Nothing Then
                    mcInterface.Guna2Panel1.Controls.Clear()
                    Dim mcQuestion10 As New MCQuestion10() ' Replace with the actual next question form
                    mcQuestion10.TopLevel = False
                    mcInterface.Guna2Panel1.Controls.Add(mcQuestion10)
                    mcQuestion10.Show()
                End If
    ...
    Private Sub MCQuestion9_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AddHandler flickerTimer.Tick, AddressOf FlickerEffect
        AddHandler transitionTimer.Tick, AddressOf TransitionSequence
        MCInterface.QuestionLbl.Text = "9" ' Update question label to show it's Question 9
    End Sub
