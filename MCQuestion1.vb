...
Public Class MCQuestion1
    ...
    Private Sub HandleWrongAnswer(button As Guna.UI2.WinForms.Guna2Button)
        ...
        UpdatePanelColor("Q1Panel", Color.FromArgb(255, 51, 52))
        QuestionScores.Q1Panel.FillColor = Color.FromArgb(255, 51, 52)
        flickerTimer.Start()
        wrongSound.Play()
    ...
    Private Sub FlickerEffect(sender As Object, e As EventArgs)
        ...
        Else
            flickerTimer.Stop()
            Guna2Button1.FillColor = Color.LightGreen
            QuestionScores.Q1Panel.FillColor = Color.LightGreen ' Set the panel color as well
            currentPhase = 1
        End If
    End Sub
