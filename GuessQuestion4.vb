...
Public Class GuessQuestion4
    ...
    Private correctAnswer As String = "swift" ' Set the correct answer for Question 4
    ...
    Private Sub GuessQuestion4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GuessInterface.QuestionLbl.Text = "4"
    ...
    Private Sub Guna2TextBox_KeyDown(sender As Object, e As KeyEventArgs)
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If userInput.ToLower() = correctAnswer Then
                ...
                UpdatePanelColor("L4Panel", Color.Gray)
                correctSound.Play()
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "L4Panel"
                    GuessScores.L3Panel.FillColor = newColor
            End Select
        End If
    End Sub

    Private Sub ShowNextQuestion()
        ' Transition to the next question (GuessQuestion5)
        ...
        If guessInterface IsNot Nothing Then
            ...
            Dim guessQuestion5 As New GuessQuestion5() ' Replace with the actual next question form
            guessQuestion5.TopLevel = False
            guessInterface.Guna2Panel1.Controls.Add(guessQuestion5)
            guessQuestion5.Show()
        End If
    End Sub
