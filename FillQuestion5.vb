...
Public Class FillQuestion5
    ...
    Private correctAnswers As String() = {"max", "return"}
    ...
    Private Sub FillQuestion5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        FillInterface.QuestionLbl.Text = "5"
    End Sub
    ...
    Private Sub ValidateAnswers()
        ...
        If correct1 AndAlso correct2 Then
            ...
            UpdatePanelColor("F5Panel", Color.Gray)
            correctSound.Play()
    ...
    Private Sub ShowNextQuestion()
        ' Embed FillQuestion6 into the Guna2Panel1 of FillInterface
        ...
        If fillInterface IsNot Nothing Then
            ...
            Dim fillQuestion6 As New FillQuestion6()
            fillQuestion6.TopLevel = False
            fillInterface.Guna2Panel1.Controls.Add(fillQuestion6)
            fillQuestion6.Show()
        End If
    End Sub
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "F5Panel"
                    FillScores.F5Panel.FillColor = newColor
            End Select
        End If
    End Sub
End Class
