...
Public Class MCQuestion6
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "Q6Panel"
                    QuestionScores.Q6Panel.FillColor = newColor
            End Select
        End If
    End Sub
    ...
    Private Sub Guna2Button3_Click(sender As Object, e As EventArgs) Handles Guna2Button3.Click
        ...
        UpdatePanelColor("Q6Panel", Color.LightGreen)
        QuestionScores.Q6Panel.FillColor = Color.LightGreen ' Change the panel color for the correct answer
        flickerTimer.Start()
        correctSound.Play()
    ...
    Private Sub HandleWrongAnswer(button As Guna.UI2.WinForms.Guna2Button)
        ...
        UpdatePanelColor("Q6Panel", Color.FromArgb(255, 51, 52))
        QuestionScores.Q6Panel.FillColor = Color.FromArgb(255, 51, 52)
        flickerTimer.Start()
        wrongSound.Play()
        ShowWrongForm()
    End Sub
    ...
    Private Sub FlickerEffect(sender As Object, e As EventArgs)
        If flickerCount < 20 Then
            ...
            Guna2Button3.FillColor = flickerColor
        Else
            flickerTimer.Stop()
            Guna2Button3.FillColor = Color.LightGreen
            QuestionScores.Q6Panel.FillColor = Color.LightGreen ' Set the panel color as well
            currentPhase = 1
        End If
    End Sub
        ...
        Select Case currentPhase
            Case 1
                ...
                If questionScores Is Nothing Then
                    ...
                    questionScores.Q6Panel.FillColor = Color.Gray ' Reflect the correct color
                    questionScores.Show()
                Else
                    questionScores.Q6Panel.FillColor = Color.Gray ' Update the color for an existing form
                End If
            ...
            Case 2
                ...
                ' Show MCQuestion7 in Guna2Panel1
                Dim mcInterface As MCInterface = Application.OpenForms.OfType(Of MCInterface)().FirstOrDefault()
                If mcInterface IsNot Nothing Then
                    mcInterface.Guna2Panel1.Controls.Clear()
                    Dim mcQuestion7 As New MCQuestion7() ' Replace with the actual next question form
                    mcQuestion7.TopLevel = False
                    mcInterface.Guna2Panel1.Controls.Add(mcQuestion7)
                    mcQuestion7.Show()
                End If
    ...
    Private Sub MCQuestion6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AddHandler flickerTimer.Tick, AddressOf FlickerEffect
        AddHandler transitionTimer.Tick, AddressOf TransitionSequence
        MCInterface.QuestionLbl.Text = "6" ' Update question label to show it's Question 6
    End Sub
