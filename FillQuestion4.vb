...
Public Class FillQuestion4
    ...
    Private correctAnswers As String() = {"x++", "x"}
    ...
    Private Sub FillQuestion4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ShowNextQuestion()
        ...
        If fillInterface IsNot Nothing Then
            ...
            Dim fillQuestion5 As New FillQuestion5()
            fillQuestion5.TopLevel = False
            fillInterface.Guna2Panel1.Controls.Add(fillQuestion5)
            fillQuestion5.Show()
        End If
    End Sub
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "F4Panel"
                    FillScores.F4Panel.FillColor = newColor
            End Select
        End If
    End Sub
End Class
