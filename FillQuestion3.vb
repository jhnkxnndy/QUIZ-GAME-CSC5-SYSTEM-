...
Public Class FillQuestion3
    ...
    Private correctAnswers As String() = {"double", "myNum"}
    ...
    Private Sub FillQuestion3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Guna2TextBox1_TextChanged(sender As Object, e As EventArgs) Handles Guna2TextBox1.TextChanged
        ...
        If Guna2TextBox1.Text.Length = 6 Then ' When 6 characters are typed in
            Guna2TextBox2.Focus()
        End If
    End Sub
    ...
    Private Sub ShowNextQuestion()
        ' Embed FillQuestion4 into the Guna2Panel1 of FillInterface
        ...
        If fillInterface IsNot Nothing Then
            ...
            Dim fillQuestion4 As New FillQuestion4()
            fillQuestion4.TopLevel = False
            fillInterface.Guna2Panel1.Controls.Add(fillQuestion4)
            fillQuestion4.Show()
        End If
    End Sub
