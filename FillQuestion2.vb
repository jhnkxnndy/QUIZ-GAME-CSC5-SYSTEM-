...
Public Class FillQuestion2
    ...
    Private correctAnswers As String() = {"num2", "sum"}
    ...
    Private Sub FillQuestion2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Guna2TextBox1_TextChanged(sender As Object, e As EventArgs) Handles Guna2TextBox1.TextChanged
        ...
        If Guna2TextBox1.Text.Length = 4 Then ' When 4 characters are typed in
            Guna2TextBox2.Focus()
        End If
    End Sub
    ...
    Private Sub ShowNextQuestion()
        ' Embed FillQuestion3 into the Guna2Panel1 of FillInterface
        ...
        If fillInterface IsNot Nothing Then
            ...
            Dim fillQuestion3 As New FillQuestion3()
            fillQuestion3.TopLevel = False
            fillInterface.Guna2Panel1.Controls.Add(fillQuestion3)
            fillQuestion3.Show()
        End If
    End Sub
