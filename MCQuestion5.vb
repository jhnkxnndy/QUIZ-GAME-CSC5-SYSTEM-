...
Public Class MCQuestion5
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        QuestionScores.Q5Panel.FillColor = Color.LightGreen 
        flickerTimer.Start()
        correctSound.Play()
        ...
        Select Case currentPhase
            Case 1
                ...
                If questionScores Is Nothing Then
                    ...
                    questionScores.Q5Panel.FillColor = Color.Gray 
                    questionScores.Show()
                Else
                    questionScores.Q5Panel.FillColor = Color.Gray 
                End If
            ...
            Case 2
                ...
                If mcInterface IsNot Nothing Then
                    ...
                    Dim mcQuestion6 As New MCQuestion6() 
    ...
    Private Sub MCQuestion5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        MCInterface.QuestionLbl.Text = "5" 
    End Sub
