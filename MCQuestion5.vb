...
Public Class MCQuestion5
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "Q5Panel"
                    QuestionScores.Q5Panel.FillColor = newColor
            End Select
        End If
    End Sub
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        UpdatePanelColor("Q5Panel", Color.LightGreen)
        QuestionScores.Q5Panel.FillColor = Color.LightGreen ' Change the panel color for the correct answer
        flickerTimer.Start()
        correctSound.Play()
    ...
    Private Sub HandleWrongAnswer(button As Guna.UI2.WinForms.Guna2Button)
        ...
        UpdatePanelColor("Q5Panel", Color.FromArgb(255, 51, 52))
        QuestionScores.Q5Panel.FillColor = Color.FromArgb(255, 51, 52)
        flickerTimer.Start()
        wrongSound.Play()
        ShowWrongForm()
    End Sub
    ...
    Private Sub FlickerEffect(sender As Object, e As EventArgs)
        ...
        Else
            flickerTimer.Stop()
            Guna2Button2.FillColor = Color.LightGreen
            QuestionScores.Q5Panel.FillColor = Color.LightGreen ' Set the panel color as well
            currentPhase = 1
        End If
    End Sub
        ...
        Select Case currentPhase
            Case 1
                ...
                If questionScores Is Nothing Then
                    ...
                    questionScores.Q5Panel.FillColor = Color.Gray ' Reflect the correct color
                    questionScores.Show()
                Else
                    questionScores.Q5Panel.FillColor = Color.Gray ' Update the color for an existing form
                End If
            ...
            Case 2
                ...
                ' Show MCQuestion6 in Guna2Panel1
                Dim mcInterface As MCInterface = Application.OpenForms.OfType(Of MCInterface)().FirstOrDefault()
                If mcInterface IsNot Nothing Then
                    mcInterface.Guna2Panel1.Controls.Clear()
                    Dim mcQuestion6 As New MCQuestion6() ' Replace with the actual next question form
                    mcQuestion6.TopLevel = False
                    mcInterface.Guna2Panel1.Controls.Add(mcQuestion6)
                    mcQuestion6.Show()
                End If
    ...
    Private Sub MCQuestion5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AddHandler flickerTimer.Tick, AddressOf FlickerEffect
        AddHandler transitionTimer.Tick, AddressOf TransitionSequence
        MCInterface.QuestionLbl.Text = "5" ' Update question label to show it's Question 5
    End Sub
