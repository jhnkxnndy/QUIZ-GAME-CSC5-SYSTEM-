...
Public Class GuessQuestion5
    ...
    Private correctAnswer As String = "ruby" ' Set the correct answer for Question 5
    ...
    Private Sub GuessQuestion5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GuessInterface.QuestionLbl.Text = "5"
    ...
    Private Sub Guna2TextBox_KeyDown(sender As Object, e As KeyEventArgs)
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If userInput.ToLower() = correctAnswer Then
                ...
                UpdatePanelColor("L5Panel", Color.Gray)
                correctSound.Play()
    ...
    Private Sub UpdatePanelColor(panelName As String, newColor As Color)
        If PanelColors.ContainsKey(panelName) Then
            ...
            Select Case panelName
                Case "L5Panel"
                    GuessScores.L4Panel.FillColor = newColor
            End Select
        End If
    End Sub
    ...
    Private Sub ShowNextQuestion()
        ...
        If guessInterface IsNot Nothing Then
            ...
            Dim guessQuestion6 As New GuessQuestion6() ' Replace with the actual next question form
            guessQuestion6.TopLevel = False
            guessInterface.Guna2Panel1.Controls.Add(guessQuestion6)
            guessQuestion6.Show()
        End If
    End Sub
End Class
