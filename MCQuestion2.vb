...
Public Class MCQuestion2
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        QuestionScores.Q2Panel.FillColor = Color.LightGreen 
        flickerTimer.Start()
        correctSound.Play()
        ...
        Select Case currentPhase
            Case 1
                ...
                If questionScores Is Nothing Then
                    ...
                    questionScores.Q2Panel.FillColor = Color.Gray 
                    questionScores.Show()
                Else
                    questionScores.Q2Panel.FillColor = Color.Gray 
                End If
            ...
            Case 2
                ...
                If mcInterface IsNot Nothing Then
                    ...
                    Dim mcQuestion3 As New MCQuestion3() 
    ...
    Private Sub MCQuestion2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        MCInterface.QuestionLbl.Text = "2" 
    End Sub
