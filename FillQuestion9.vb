...
Public Class FillQuestion9
    ...
    Private correctAnswers As String() = {"[4]", "cars"} ' Correct answers for this question
    ...
    Private Sub ShowNextQuestion()
        ' Embed FillQuestion10 into the Guna2Panel1 of FillInterface
